...
download_binary() {
    ...
    version=$(curl -s https://api.github.com/repos/faelmori/logz/releases/latest | \
    ...
    release_url="https://github.com/faelmori/logz/releases/download/${version}/logz_${os}_${arch}.tar.gz"
